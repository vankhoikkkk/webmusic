...
<body>
    <?php 
            ...
            $query = mysqli_query($connect, "SELECT * FROM `baihat`,`casi` WHERE baihat.id_casi = casi.id_casi and baihat.id_baihat BETWEEN 1 and 90 ORDER by baihat.luotnghe DESC;");
            $count = 0;
